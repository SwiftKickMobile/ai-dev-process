...
- 2026-02-13 Restructured repository toward IDE-neutral `.md` sources (`Core/`, `Policies/`, `Templates/`, `Install/`).
...
- 2026-02-13 Added migration-capable install/update discussion record in `DISCUSSION.md`.
