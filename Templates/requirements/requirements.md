...
- [`platform/`](platform/platform.md) -- system-wide invariants (protocol-level, format-level, infrastructure-level rules).
- [`domains/`](domains/domains.md) -- business / domain rules (entities, invariants, state transitions).
- [`features/`](features/features.md) -- user-facing capabilities reusable across apps.
- [`apps/`](apps/apps.md) -- per-app behavior.
